        ...
        >
          ...
          {Icon && (
            <Icon
              aria-hidden="true"
              className={cx(
                "ml-2 size-4 shrink-0 stroke-[2.25px] stroke-black",
...
const DropdownPopover = (props: DropdownPopoverProps) => {
  return (
    <AriaPopover
      ...
      className={(state) =>
        cx(
          "min-w-(--trigger-width) origin-(--trigger-anchor-point) overflow-auto rounded-lg bg-primary shadow-lg ring-1 ring-secondary_alt will-change-transform",
          state.isEntering &&
